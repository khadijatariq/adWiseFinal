...
.factory('User', function($http) {
	...
	userFactory.storeAllCourses = function() {
		...
		prereq = ["None","CS100","CS200","CS210","None","CS200","CS200","CS202","CS200","CS471","MATH230","CS210 and CS 202","CS370","CS310 and CS 202","CS202","CS360","None","CS370","None","MATH101 ,MATH230 and MATH210","CS536","None","CS446","None","CS5310","CS210"]; //not added yet
		field = ["Algorithms","Algorithms","Algorithms","Algorithms","Artificial Intelligence","Software Engineering","Computer Networks","Algorithms","Computer Graphics","Computer Networks","Algorithms","Algorithms","Operating System","Algorithms","Algorithms","Software Engineering","Software Engineering","Software Engineering","Operating System","Operating System","Algorithms","Algorithms","Software Engineering","Human Computer Interaction","Algorithms","Graphics","Algorithms"]; //not added yet
