...
.factory('User', function($http) {
	...
	userFactory.storeAllCourses = function() {
		...
		field = ["Algorithms","Algorithms","Algorithms","Algorithms","Artificial Intelligence","Software Engineering","Computer Networks","Artificial Intelligence","Computer Graphics","Computer Networks","Algorithms","Algorithms","Operating System","Artificial Intelligence","Artificial Intelligence","Software Engineering","Software Engineering","Operating System","Operating System","Algorithms","Artificial Intelligence","Software Engineering","Human Computer Interaction","Algorithms","Graphics","Algorithms"];
	...
	userFactory.getCareerInst = function(career) {
		return $http.post('api/getcareerinst', {name : career});
	} 

	userFactory.getSuggestions = function(crs,crs1) {
		s1 = [];
		crs.forEach(function(c){
			check = true;
			crs1.forEach(function(d){
				x = d.subject+d.catalog.slice(1,d.catalog.length);
				if (c.catalog == x){
					check = false;
				}
			});
		...
		s2.forEach(function(c){
			if (c.catalog == "CS100" || c.catalog == "CS202" || c.catalog == "CS300" || c.catalog == "CS315"){
				s3[0].push(c);
			} else {
				s3[1].push(c);
			}
